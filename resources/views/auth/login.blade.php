    ...
    <div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        <div
            ...
            <div class="p-5 bg-white md:flex-1">
                <h3 class="my-4 text-2xl font-semibold text-gray-700">Account {{ __('Login') }}</h3>
                <form method="POST" action="{{ route('login') }}" class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center justify-between">
                            <label for="password" class="text-sm font-semibold text-gray-500">{{ __('Password')
                                }}</label>
                            @if (Route::has('password.request'))
                            <a class="text-sm text-blue-600 hover:underline focus:text-blue-800"
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <label for="remember" class="text-sm font-semibold text-gray-500">{{ __('Remember Me')
                            }}</label>
                    </div>
                    <div>
                        <button type="submit"
                    ...
                    <div class="flex flex-col space-y-5">
                        ...
                        <div class="flex flex-col space-y-4">
                            ...
                            <a href="#"
                                ...
                                <span>
                                    <svg class="text-blue-500 group-hover:text-white" width="20" height="20"
                                        fill="currentColor">
                                        <path
